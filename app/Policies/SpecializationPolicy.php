...
class SpecializationPolicy
{
    ...
    {
        return $user->can('force_delete_specialization');
    }
    ...
    {
        return $user->can('force_delete_any_specialization');
    }
    ...
    {
        return $user->can('restore_any_specialization');
    }
    ...
    {
        return $user->can('replicate_specialization');
    }
    ...
    {
        return $user->can('reorder_specialization');
    }
}
