...
use Modules\Crops\Filament\Resources\FertilizerCategoryResource\Pages;
use Modules\Crops\Models\FertilizerCategory;

class FertilizerCategoryResource extends Resource
{
    use HasTranslatedFilamentLabels;

    protected static ?string $model = FertilizerCategory::class;

    protected static ?string $navigationIcon = 'heroicon-o-archive-box';

    protected static ?string $navigationLabel = 'Fertilizer Categories';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('fertilizers_count')
                    ->label('Fertilizers')
                    ->counts('fertilizers')
                    ->badge()
                    ->color('info'),
    ...
    {
        return [
            'index' => Pages\ListFertilizerCategories::route('/'),
            'create' => Pages\CreateFertilizerCategory::route('/create'),
            'edit' => Pages\EditFertilizerCategory::route('/{record}/edit'),
        ];
    }
}
