...
class WeedsRelationManager extends RelationManager
{
    protected static string $relationship = 'weeds';

    public static function getTitle(\Illuminate\Database\Eloquent\Model $ownerRecord, string $pageClass): string
    {
        return __('admin-panel.relation_labels.weeds');
    }
